...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){
		if($("#tabs").tabs("exists",text)){
			...
			var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${webctx}/admin/"+url+"'></iframe>";
			$("#tabs").tabs("add",{
				title:text,
				iconCls:iconCls,
				closable:true,
	...
	function openPasswordModifyDialog(){
		...
		url="${webctx}/admin/blogger/modifyPassword.do?id=${currentUser.id}";
	}
	...
	function logout(){
		$.messager.confirm("系统提示","您确定要退出系统吗？",function(r){
			if(r){
				window.location.href='${webctx}/admin/blogger/logout.do';
			} 
		 });
	}
	
	function refreshSystem(){
		$.post("${webctx}/admin/system/refreshSystem.do",{},function(result){
			if(result.success){
...
<div region="north" style="height: 78px;background-color: #E0ECFF">
	<table style="padding: 5px" width="100%">
		<tr>
			<td width="50%">
				<img alt="logo" src="${webctx}/static/images/logo.png">
			</td>
