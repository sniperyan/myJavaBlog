...
<script type="text/javascript">
	...
	function deleteLink(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${webctx}/admin/link/delete.do",{ids:ids},function(result){
						if(result.success){
	...
	function openLinkModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${webctx}/admin/link/save.do?id="+row.id;
	 }
...
<table id="dg" title="友情链接管理" class="easyui-datagrid"
   ...
   url="${webctx}/admin/link/list.do" fit="true" toolbar="#tb">
   <thead>
   	<tr>
